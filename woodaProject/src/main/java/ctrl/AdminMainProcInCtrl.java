...
@WebServlet("/present_in")
public class AdminMainProcInCtrl extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public AdminMainProcInCtrl() { super(); }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		AdminMainProcInSvc adminMainProcInSvc = new AdminMainProcInSvc();
		
		result = adminMainProcInSvc.InsertPresent(recommendPresent);
