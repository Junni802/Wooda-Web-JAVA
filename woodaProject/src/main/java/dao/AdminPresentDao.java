...
public class AdminPresentDao {
	private static AdminPresentDao adminPresentDao;
	private Connection conn;
	private AdminPresentDao() {}

	public static AdminPresentDao getInstance() {
		if (adminPresentDao == null)	adminPresentDao = new AdminPresentDao();
		return adminPresentDao;
	}
