...
public class ReportDao {
	...
	public int reportInsert(ReportInfo reportInfo) {
		...
		try {
			...
			sql = "Insert into t_board_112(b1_idx, bs_num, mi_mail, b1_content, b1_ip) values(" + idx + ", '" + reportInfo.getBs_num() + "', '" + reportInfo.getMi_mail() + "', '" + reportInfo.getB1_content() + "', '" + reportInfo.getB1_ip() + "')";
