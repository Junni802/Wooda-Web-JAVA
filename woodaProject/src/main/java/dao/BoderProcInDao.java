	...
	public int borderInsert(BorderInfo borderInfo) {
		...
		try {
			...
			sql = "insert into t_board_story(bs_num, mi_mail, mi_nick, bs_area, bs_title, bs_start, bs_end, bs_content, bs_visit, bs_gender, bs_lat1, bs_lng1, bs_place1, bs_lat2, bs_lng2, bs_place2, bs_lat3, bs_lng3, " + 
					" bs_place3, bs_img1, bs_img2, bs_img3, bs_img4, bs_img5, bs_astatus, bs_cstatus, bs_ip) " + 
					" values (" + idx + ", '" + borderInfo.getMi_mail() + "', '" + borderInfo.getMi_nick() + "', '"+ borderInfo.getBs_area() +"' , '" + borderInfo.getBs_title() + "' , '" + 
					...
					borderInfo.getBs_img1() + "' , '" + borderInfo.getBs_img2() + "', '" + borderInfo.getBs_img3() + "', '" + borderInfo.getBs_img4() + "', '" + borderInfo.getBs_img5() + "', '" + borderInfo.getBs_astatus() + "' , '" + borderInfo.getBs_cstatus() + "' , '" + borderInfo.getBs_ip() + "')";
