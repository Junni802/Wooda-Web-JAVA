...
public class BoderViewDao {
	...
	public int getBorderLike (int idx, String mi_mail) {
		...
		try {
			...
			System.out.println("BoderViewDao 클래스의 getBorderLike() 메소드 오류");
			e.printStackTrace();
		} finally {
			close(rs);	close(stmt);
		}
	...
	public int getBorderComment(int idx) {
		...
		try {
			...
			System.out.println("BoderViewDao 클래스의 getBorderComment() 메소드 오류");
			e.printStackTrace();
		} finally {
			close(rs);	close(stmt);
		}
	...
	public ArrayList<BorderComment> getBorderList(int idx) {
		...
		try {
			...
			System.out.println("BoderViewDao 클래스의 getBorderList() 메소드 오류");
			e.printStackTrace();
		} finally {
			close(rs);	close(stmt);
		}		
