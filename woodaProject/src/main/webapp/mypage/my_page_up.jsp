...
#profiletable1, #profiletable2, #profiletable3  {
	width: 1150px;
	height: 330px;
	margin-left: auto;
	margin-right: auto;
...
#profiletable1 table th, table td {
...
<body>
	<h2 style="text-align: left; padding-left: 180px;">프로필 수정</h2>
		...
		<div id="profileZone">
			<form name="forms" action="my_page_up" method="post">
				...
				<table id="profileTable1" border="1" class="profileTable">
					<tr>
						<td rowspan="3" width="30%" style="text-align: -webkit-center;"><div id="profileDiv">
			...
			<input type=button name=profileModify value="수정 완료" class="cbtn"
				onclick="frmCom('a');" />
		</div>
		<hr />
		<div id="profileZone">
