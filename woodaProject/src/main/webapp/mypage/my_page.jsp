...
<style>
hr {width:1150px; text-align:center;}

#profileImg {width: 150px; height: 150px; }
#profileDiv {width: 150px; height: 150px;  border-radius: 70%; overflow: hidden;}
#profileZone { height:350px; padding-bottom: 20;}
#couplePostZone { height:350px; width: 1150px;}
fieldset {border:0;}
#profileZone table {border:solid 1px black; width:1150px; height:330px; margin-left:auto; margin-right:auto; text-align:center;}
#profileDiv table {border:solid 1px black; width:1150px; height:330px; margin-left:auto; margin-right:auto; text-align:center;}
.cbtn {margin-left: 1050; padding: 10; }
#list img { width: 150px; height: 150px;}
#list { width: 1150px; }
</style>
<Script>
          
...
<h2 style="text-align: left; padding-left: 180px;">마이 페이지</h2>
<div id="profileZone">
<table id="profileTable" border="1">

<tr>

<td rowspan="3" width="40%" style="padding-left: 46px;"><div id="profileDiv"><img src="img/<%=loginInfo.getMi_pimg()%>" id="profileImg"/></div></td>
...
<input type=button name=profileModify value="프로필 수정" onclick="location.href='mypage_up_dispatcher'" class="cbtn"/>
</div>
<hr/>
