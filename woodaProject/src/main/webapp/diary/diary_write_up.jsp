...
<body>
<div class="diaryUpBody">
<form name="frm" action="write_proc_up" method="post" onsubmit="return test()" >
<input type="hidden" name="ci_idx" value="<%=loginInfo.getCi_idx() %>" />
...
<tr>
<td colspan="2"/>
<% if(borderInfo.getBs_img5() != null && !borderInfo.getBs_img5().equals("")) { %>
이미지 5개를 이미 다 등록하셨습니다.
<input type="hidden" name="bs_img1" value="<%=borderInfo.getBs_img1() %>" />
<input type="hidden" name="bs_img2" value="<%=borderInfo.getBs_img2() %>" />
<input type="hidden" name="bs_img3" value="<%=borderInfo.getBs_img3() %>" />
<input type="hidden" name="bs_img4" value="<%=borderInfo.getBs_img4() %>" />
<input type="hidden" name="bs_img5" value="<%=borderInfo.getBs_img5() %>" />
<% }else if(borderInfo.getBs_img4() != null && !borderInfo.getBs_img4().equals("")) { %>
파일1 등록 완료.<br />
파일2 등록 완료.<br />
파일3 등록 완료.<br />
파일4 등록 완료.<br />
...
<input type="hidden" name="bs_img3" value="<%=borderInfo.getBs_img3() %>" />
<input type="hidden" name="bs_img4" value="<%=borderInfo.getBs_img4() %>" />
<input type="file" id="isImageFile5" name="bs_img5" onchange="readURL5(this);" >
<% }else if(borderInfo.getBs_img3() != null && !borderInfo.getBs_img3().equals("")) { %>
파일1 등록 완료.<br />
파일2 등록 완료.<br />
파일3 등록 완료.<br />
<input type="hidden" name="bs_img1" value="<%=borderInfo.getBs_img1() %>" />
<input type="hidden" name="bs_img2" value="<%=borderInfo.getBs_img2() %>" />
<input type="hidden" name="bs_img3" value="<%=borderInfo.getBs_img3() %>" />
<input type="file" id="isImageFile4" name="bs_img4" onchange="readURL4(this);" >
<input type="file" id="isImageFile5" name="bs_img5" onchange="readURL5(this);" >
<% }else if(borderInfo.getBs_img2() != null && !borderInfo.getBs_img2().equals("")) { %>
파일1 등록 완료.<br />
파일2 등록 완료.<br />
<input type="hidden" name="bs_img1" value="<%=borderInfo.getBs_img1() %>" />
<input type="hidden" name="bs_img2" value="<%=borderInfo.getBs_img2() %>" />
<input type="file" id="isImageFile3" name="bs_img3" onchange="readURL3(this);" >
<input type="file" id="isImageFile4" name="bs_img4" onchange="readURL4(this);" >
<input type="file" id="isImageFile5" name="bs_img5" onchange="readURL5(this);" >
<% }else if(borderInfo.getBs_img1() != null && !borderInfo.getBs_img1().equals("")) { %>
파일1 등록 완료.<br />
<input type="hidden" name="bs_img1" value="<%=borderInfo.getBs_img1() %>" />
<input type="file" id="isImageFile2" name="bs_img2" onchange="readURL2(this);" >
<input type="file" id="isImageFile3" name="bs_img3" onchange="readURL3(this);" >
<input type="file" id="isImageFile4" name="bs_img4" onchange="readURL4(this);" >
<input type="file" id="isImageFile5" name="bs_img5" onchange="readURL5(this);" >
<% }else { %>
<input type="file" id="isImageFile1" name="bs_img1" onchange="readURL1(this);" >
<input type="file" id="isImageFile2" name="bs_img2" onchange="readURL2(this);" >
<input type="file" id="isImageFile3" name="bs_img3" onchange="readURL3(this);" >
<input type="file" id="isImageFile4" name="bs_img4" onchange="readURL4(this);" >
<input type="file" id="isImageFile5" name="bs_img5" onchange="readURL5(this);" >
...
<td colspan="2">
<% if(borderInfo.getBs_img5() != null && !borderInfo.getBs_img5().equals("")) { %>
<img class="captionImg" src="/woodaProject/img/<%=borderInfo.getBs_img1() %>" />
<br />
<img class="captionImg" src="/woodaProject/img/<%=borderInfo.getBs_img2() %>" />
<br />
<img class="captionImg" src="/woodaProject/img/<%=borderInfo.getBs_img3() %>" />
<br />
<img class="captionImg" src="/woodaProject/img/<%=borderInfo.getBs_img4() %>" />
<br />
<img class="captionImg" src="/woodaProject/img/<%=borderInfo.getBs_img5() %>" />
<% }else if(borderInfo.getBs_img4() != null && !borderInfo.getBs_img4().equals("")) { %>
<img class="captionImg" src="/woodaProject/img/<%=borderInfo.getBs_img1() %>" />
<br />
<img class="captionImg" src="/woodaProject/img/<%=borderInfo.getBs_img2() %>" />
...
<img class="captionImg" src="/woodaProject/img/<%=borderInfo.getBs_img1() %>" />
<% } %>
<textarea minlength="4" rows="35px" name="bs_content" >
